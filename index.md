...
Markdown, Quarto, or a
[`save_html()`](https://rstudio.github.io/htmltools/reference/save_html.html)
file on disk.
...
Attach it once per page and it lands in the `<head>`, de-duplicated
across the render.
